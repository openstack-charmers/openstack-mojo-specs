...
def main(argv):
    ...
    router = neutron_client.list_routers(name=router_name)['routers'][0]
    hosting_machine = neutron_client.list_l3_agent_hosting_routers(router=router['id'])['agents'][0]['host']
